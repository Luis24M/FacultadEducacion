...
<div class="bg-white">
  ...
  <section class="min-h-60 md:min-h-96 w-full bg-black flex items-center justify-center gap-5 p-10">
  ...
  <section class="container mx-auto p-5" id="resena-historica">
    <header class="p-5">
  ...
  <section class="md:flex p-5" id="perfilProfesional">
      <div class="container mx-auto p-5">
        <h2 class="text-2xl text-black font-semibold mb-4">Perfil Profesional</h2>
        <p class="text-black">
      ...
      <div class="container mx-auto p-5">
        <h2 class="text-2xl text-black font-semibold mb-4">Campo Ocupacional</h2>
        <p class="text-black">El egresado de Ciencias de la Comunicación de la Universidad Nacional de Trujillo está capacitado para desempeñarse como gestor o director en cualquier empresa de comunicación. Asimismo, tiene la habilidad y conocimiento para emprender la formación de alguna vinculada a:
        </p>
        <ul class="list-disc list-inside text-black pl-4">
  ...
  <section class="p-5 md:flex" id="planEstudios">
      <div class="container mx-auto p-5 md:w-1/3">
          ...
          <div class="pl-3">
              <ul class="list-disc list-inside text-gray-900 space-y-2">
                  <li>
