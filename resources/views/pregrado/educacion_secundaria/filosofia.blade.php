    ...
    <section class="max-w-[1050px] flex flex-col mx-auto p-5 md:px-0">
            ...
            <section class="contenido active" id="nosotros">
                ...
                <div class="lg:flex lg:space-x-10">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-md md:text-lg text-gray-700">
                            “La carrera de Filosofía, Psicología y Ciencias Sociales busca ser reconocida nacional e internacionalmente por su equipo humano capacitado y creativo, que brinda educación de calidad y fomenta la formación integral de sus estudiantes. Promueve una cultura democrática y abierta al debate académico, la tolerancia y la transformación social, además de establecer vínculos con instituciones para mejorar la formación docente y curricular, apoyando el desarrollo del talento humano y los objetivos institucionales.”.
                        </p>
                    </div>
            </section>
        ...
        <section class="datos order-first max-w-6xl px-5 md:px-20 mx-auto my-6 flex flex-col lg:flex-row justify-center gap-6 ">
            ...
            <div class="bg-[#fee346] p-6 rounded-lg shadow-lg text-center flex flex-col justify-center lg:w-1/3">
                ...
                <p class="">"Bienvenidos a la Escuela Profesional de Educación Secundaria Mención Filosofía,
            ...
            <div class="flex flex-col justify-between lg:w-1/3">
                ...
                <div class="bg-[#8B0000] h-1/2 p-6 rounded-b-lg shadow-lg flex flex-col justify-evenly text-center">
                    ...
                    class="text-md font-bold text-white mb-2 text-wrap">secundaria@unitru.edu.pe</a>
                </div>
            </div>
