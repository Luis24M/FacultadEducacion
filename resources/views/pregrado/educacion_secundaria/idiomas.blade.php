    ...
    <section class="max-w-[1050px] flex flex-col justify-between mx-auto p-5 md:px-0">
        ...
        <section class="contenedor-contenido [&>section]:p-5 md:[&>section]:px-20 md:[&>section]:py-10">
            <section class="contenido active" id="nosotros">
                ...
                <div class="lg:flex lg:space-x-10">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-md md:text-lg text-gray-700">
                            En el año 2025, seremos una unidad académica acreditada, que contribuye al desarrollo
                            sustentable de la región,
                            del país y del mundo, sensible a las exigencias sociales, que forma profesionales con excelencia
                            académica en idiomas,
                            se proyecta a la comunidad con responsabilidad social, realiza investigación científica, respeta
                            la diversidad cultural
                            y la ecología, y contribuye a la formación integral del ser humano dentro del marco de los
                            valores ético y estéticos.
                            </br><b class="text-sm italic">Currículo del Programa de Estudios de Educación Secundaria
                                Idiomas(2018)</b>
                        </p>
                    </div>
            ...
            <section class="contenido lg:flex" id="perfil" style="display:none;">
                <div>
                    ...
                    <ul class="list-disc flex flex-col gap-1 p-4 text-md md:text-lg ml-8">
                        ...
                        <li class="text-gray-700">Posee aptitud para el procesamiento de sistemas lingüísticos, demostrando
                            competencias básicas en la comprensión y producción de textos orales y escritos.</li>
                        <li class="text-gray-700">Tiene información básica de las Ciencias Naturales, Sociales y Formales;
                            así como, de la cultura humanística en perspectiva histórica a niveles del Perú y el mundo.
                            Tiene interés por la investigación científica.</li>
                        ...
                        <li class="text-gray-700">Tiene capacidad de liderazgo, vocación de servicio y sensibilidad social.
                        </li>
                ...
                <div>
                    ...
                    <ul class="list-disc flex flex-col gap-1 p-4 text-gray-700 text-md md:text-lg ml-8">
                        <li>Un Licenciado en Educación Secundaria con Mención en Inglés-Francés o Inglés-Alemán es un
                            profesional comprometido con la formación integral de estudiantes adolescentes.</li>
                        <li>Este educador posee sólidos conocimientos en pedagogía y didáctica, especializándose en la
                            enseñanza de los idiomas inglés y, francés o alemán. Su enfoque abarca el desarrollo de
                            habilidades lingüísticas, la promoción de la comunicación efectiva y la apertura a la diversidad
                            cultural.</li>
                        <li>Con una pasión por inspirar el amor por los idiomas, este licenciado contribuye al crecimiento
                            académico y personal de sus estudiantes, preparándolos para enfrentar un mundo globalizado con
                            confianza y competencia lingüística.</li>
                    </ul>
                </div>
            </section>
            ...
            <section class="contenido " id="campo" style="display:none;">
                ...
                <div class="container">
                    <p class="text-gray-700 text-md md:text-lg">Las salidas profesionales para un Licenciado en Educación
                        con Mención en Idiomas abarcan diversas áreas:</p>
                    <ul class=" list-inside text-gray-700 ml-8 text-md md:text-lg">
                        <li class="flex mt-2">
                            ...
                            <p class="ml-2 ">
                                <span class="font-bold "> Enseñanza de idiomas: </span> Imparte clases de idiomas en
                                diversos entornos educativos, guiando a los estudiantes en su aprendizaje y creando un
                                ambiente dinámico.
                            </p>
                        </li>
                        <li class="flex mt-2">
                            ...
                            <p class="ml-2 ">
                                <span class="font-bold "> Gestión de instituciones educativas: </span> Lidera y administra
                                instituciones, organizando recursos y tomando decisiones estratégicas para fomentar un
                        ...
                        <li class="flex mt-2">
                            ...
                            <p class="ml-2 ">
                                <span class="font-bold "> Asesoramiento y consultoría: </span> Ofrece orientación a otros
                                educadores en programas de capacitación, mejorando la calidad pedagógica y el entorno
                                educativo.
                            </p>
                        </li>
                        <li class="flex mt-2">
                            ...
                            <p class="ml-2 ">
                                <span class="font-bold ">Liderazgo de proyectos educativos: </span>Emprende iniciativas
                                educativas innovadoras, liderando proyectos que transforman la educación con prácticas
                                pedagógicas creativas y efectivas.
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <section class="contenido text-center text-white" id="plan-estudios" style="display:none;">
                <div
                    class=" grid drop-shadow-lg mb-10 lg:grid-cols-6 gap-5 [&>div]:rounded-md [&>div]:text-center [&>div]:p-2 [&>div]:flex [&>div]:flex-col [&>div]:justify-center [&>div]:items-center">
                    ...
                    <div class="bg-blue-900 lg:col-span-4">
                        ...
                        <h2 class="font-semibold text-lg">Bachiller en Educación Secundaria, Mención Idiomas:
                            Inglés-Francés o Inglés-Alemán</h2>
                    </div>
                    <div class="bg-blue-900 lg:col-span-4">
                        <h3>Titulo</h3>
                        <img src="{{ asset('icons/diploma.svg') }}" alt="diploma-icon" class="w-16">
                        <h2 class="font-semibold  text-lg">Licenciado en Educación Secundaria, Mención Idiomas:
                            Inglés-Francés o Inglés-Alemán</h2>
                    </div>
            ...
            <section class="contenido text-center" id="contactanos" style="display: none;">
                <x-form-programa color="blue-800" programa="Idiomas" />
            </section>
        </section>
            ...
            <div class="bg-red-700 p-6 rounded-lg shadow-lg text-center">
                <div class="text-red-500 mb-4 flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 36 36">
                        <path fill="#292f33"
                            d="M6 15h24v2H6zm15 15c0 2.208-.792 4-3 4s-3-1.792-3-4s.791-2 3-2s3-.208 3 2" />
