	...
	<section class="contenedor-contenido [&>section]:p-5 md:[&>section]:px-20 md:[&>section]:py-10">
		...
		<section class="contenido lg:flex" id="perfil" style="display:none;">
			<div>
				...
				<ul class="flex flex-col gap-1 p-4 text-md lg:text-lg text-gray-700 ">
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Posee aptitud para el procesamiento de sistemas lingüísticos, demostrando competencias básicas en la comprensión y producción de textos orales y escritos.
						</p>
					</li>
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Tiene información básica de las Ciencias Naturales, Sociales y Formales; así como, de la cultura humanística en perspectiva histórica a niveles del Perú y el mundo.
						</p>
					</li>
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Tiene interés por la investigación científica.
						</p>
					</li>
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Es crítico, reflexivo y actúa con coherencia y lógica.
						</p>
					</li>
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Maneja herramientas básicas en TIC's.
						</p>
					</li>
					...
					<li class="flex mt-2">
						...
						<p class="ml-2 ">
							Muestra capacidad de trabajo individual y en equipo.
						</p>
					</li>
			...
			<div>
				...
				<ul class="flex flex-col gap-1 p-4 text-md lg:text-lg text-gray-700">
					<li class="flex">
						...
						<p class="ml-2">
							Un Licenciado en Educación Secundaria con Mención en Inglés-Francés o Inglés-Alemán es un profesional comprometido con la formación integral de estudiantes adolescentes.
						</p>
					</li>
					...
					<li class="flex">
						...
						<p class="ml-2">
							Posee sólidos conocimientos en pedagogía y didáctica, especializándose en la enseñanza de los idiomas inglés y, francés o alemán. Su enfoque abarca el desarrollo de habilidades lingüísticas, la promoción de la comunicación efectiva y la apertura a la diversidad cultural.
						</p>
					</li>
					<li class="flex">
						<i class="text-blue-800">
