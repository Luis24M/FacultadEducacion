    ...
    <div class="hero">
        <div class="overlay">
            <div class="content">
                ...
                <p>¡Bienvenidos a Educación Secundaria con énfasis en inglés y, francés o alemán! En este viaje educativo, formarás parte esencial y guiarás el aprendizaje profundo de dos idiomas internacionales. ¡Comencemos juntos esta travesía hacia un futuro de descubrimientos en la Educación Secundaria!</p>
    ...
    <section class="about-section">
        ...
        <div class="about-text">
            ...
            <p class= "parrafo" >Un Licenciado en Educación Secundaria con Mención en Inglés-Frances o Inglés Alemán es un profesional comprometido con la formación integral de estudiantes adolescentes. Este educador posee sólidos conocimientos en pedagogía y didáctica, especializándose en la enseñanza de los idiomas inglés y, francés o alemán. Su enfoque abarca el desarrollo de habilidades lingüísticas, la promoción de la comunicación efectiva y la apertura a la diversidad cultural. Con una pasión por inspirar el amor por los idiomas, este licenciado contribuye al crecimiento académico y personal de sus estudiantes,
               ...
               sea una prueba de la dedicación y el compromiso de nuestros estudiantes y educadores.</p>
            <ul>
                <li>Duración de Estudios: 10 Semestres Académicos</li>
                <li>Grado Académico: Bachiller en Educación Secundaria, Mención Idiomas: Inglés-Francés o Inglés-Alemán</li>
                <li>Título Profesional: Licenciado en Educación Secundaria, Mención Idiomas: Inglés-Francés o Inglés-Alemán</li>
            </ul>
