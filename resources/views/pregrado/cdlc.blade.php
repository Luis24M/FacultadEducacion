...
@section('content')
    ...
    <main>
        <h1 class="text-3xl md:text-5xl text-white bg-gray-400 w-full p-7 font-bold">Escuela Profesional de Ciencias de la
            Comunicación</h1>
            ...
            <section class="contenedor-contenido [&>section]:p-5 md:[&>section]:px-20 md:[&>section]:py-10">
                    ...
                    <div class="lg:flex lg:space-x-10">
                        ...
                        <div class="flex-1">
                            <div class="flex text-gray-700">
                                ...
                                <h3 class="text-lg md:text-xl font-semibold mx-2 tracking-wide text-gray-900 mb-4">Visión
                                </h3>
                            </div>
                            ...
                            <p class="text-md md:text-lg text-gray-700">
                                ...
                                <b class="text-sm">"Currículo del Programa de Estudios de Ciencias de la
                                    Comunicación(2018)".</b>
                            </p>
                        </div>
                        ...
                        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            @foreach ($docentes as $docente)
                                <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
                                    ...
                                    <img class="w-full h-64 object-cover" src="{{ asset($docente['foto']) }}"
                                        alt="FotoDocente">
                ...
                <section class="contenido lg:flex" id="perfil" style="display:none;">
                        ...
                        <ul class="space-y-4 text-lg text-gray-700 pl-5">
                            <li class="flex">
                                ...
                                <p class="ml-2">
                                    ...
                                    Comprende una base sólida en áreas fundamentales para una educación integral. Incluye
                                    razonamiento verbal y matemático, que permiten desarrollar habilidades de comprensión y
                                    solución de problemas; además, conocimientos en política, economía y geopolítica para
                                    entender la sociedad; el marco legal constitucional para la comprensión de derechos y
                                    deberes, y la historia de la cultura, que aporta perspectiva y contexto histórico.
                                </p>
                            ...
                            <li class="flex">
                                ...
                                <p class="ml-2">
                                    ...
                                    Se enfoca en las habilidades prácticas y analíticas necesarias para procesar y aplicar
                                    conocimientos. Esto incluye la capacidad de análisis y síntesis para interpretar
                                    información compleja, argumentación para comunicar ideas de manera persuasiva, manejo
                                    básico de TIC’s, comprensión de textos para entender contenido escrito, y producción de
                                    textos para expresar ideas de forma coherente.
                                </p>
                            </li>
                            ...
                            <li class="flex">
                                ...
                                <p class="ml-2">
                                    ...
                                    Define los valores y disposiciones que orientan la conducta y motivación en el
                                    aprendizaje y el trabajo. Implica vocación y motivación para comprometerse, respeto
                                    hacia sí mismo y los demás, trabajo en equipo, capacidad para tomar decisiones en
                                    situaciones nuevas, perseverancia en la consecución de metas, habilidad en la
                                    comunicación, liderazgo, ética y responsabilidad, así como creatividad, iniciativa y
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 text-lg">
                            Planifica, implementa y evalúa proyectos de comunicación, publicidad y marketing, destacando la
                            importancia de la comunicación interpersonal con diversos públicos. Utiliza la investigación
                            para realizar diagnósticos y análisis de contextos e impactos. Desarrolla contenidos para medios
                            tradicionales y digitales, trabajando de forma dependiente o independiente. Respeta la
                            cosmovisión y cultura de los contextos en los que interviene. Demuestra creatividad, trabajo en
                            equipo, eficiencia, resiliencia, responsabilidad, dinamismo y energía en sus actividades y
                            roles.
                        </p>
                ...
                <section class="contenido active" id="campo" style="display:none;">
                    ...
                    <div class="container text-gray-700 text-lg">
                        ...
                        <p>
                            El egresado de Ciencias de la Comunicación de la Universidad Nacional de Trujillo está
                            capacitado para desempeñarse como gestor o director en cualquier empresa de comunicación.
                            Asimismo, tiene la habilidad y conocimiento para emprender la formación de alguna actividad
                            vinculada a:
                        </p>
                ...
                <section class="contenido text-center" id="contactanos" style="display: none;">
                    <x-form-programa color="gray-400" programa="Ciencias de la Comunicacion" />
                </section>

            </section>

            <section
                class="datos order-first p-5 md:px-20 mx-auto my-6 grid grid-cols-1 lg:grid-cols-3 gap-6 text-black-100 ">

                <!-- Primera columna: Bienvenida -->
                <div class="bg-gray-500 p-6 rounded-lg shadow-lg text-center">
                    <div class="mb-4 flex justify-center">
                        <svg class="drop-shadow-lg" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                            viewBox="0 0 36 36">
                            <path fill="#292f33"
