<nav class="h-24 w-full bg-[#FFD54F] flex items-center justify-between grow gap-4 px-2">
        <div class="lg:hidden">

        </div>
    <section class="flex flex-col lg:hidden text- items-center">
...
<ul id="mobile-menu"
    class="flex flex-col bg-[#eee] text-black h-[calc(100dvh-80px)] transition-all duration-300 hidden w-full justify-around p-6
        ">
    <li class="py-2 hover:font-bold transition-all duration-300"><i class="fa-solid fa-angle-right mr-1"></i><a class=""
