...
<div class="container mx-auto p-8">
    ...
    <div class="grid grid-cols-4 gap-6">
        <!-- Columna izquierda ocupando 1/4 del espacio total -->
        ...
        <!-- Columna derecha ocupando 3/4 del espacio total -->
...
<script>
    // Variables globales para controlar las secciones
    const opciones = {
        'inicial': true,
        'primaria': false,
        'Filosofia Psicologia y CCSS': false,
        'Ciencias Matemáticas': false,
        'Idiomas': false,
        'Lengua y literatura': false,
        'Historia y Geografia': false,
        'Ciencias Naturales': false,
        'Ciencias de la comunicación': false
    };
