    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <h2 class="text-2xl font-semibold text-center mb-4">Licenciamiento Institucional</h2>
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-center p-6 bg-yellow-50 rounded-lg border-2 border-yellow-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <p class="text-lg text-yellow-700">El proceso de licenciamiento actualmente se encuentra suspendido por
                            la SUNEDU.</p>
                    </div>
                </div>
            </div>
