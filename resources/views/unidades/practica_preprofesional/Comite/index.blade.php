...
<div class="bg-white p-6 rounded-lg shadow-lg">
    <h1 class="text-3xl font-bold text-center mb-4 text-blue-600">Comité</h1>
...
<script>
    ...
    const programs = {
        program1: [
            { name: "Dr. Javier Soto", role: "Director", email: "javier.soto@universidad.edu", phone: "+51 999 111 111" },
            { name: "Lic. Elena Ruiz", role: "Coordinadora", email: "elena.ruiz@universidad.edu", phone: "+51 988 222 222" },
            { name: "Lic. Andrés Gómez", role: "Asistente", email: "andres.gomez@universidad.edu", phone: "+51 977 333 333" },
        ],
        program2: [
            { name: "Dr. Luis Vargas", role: "Director", email: "luis.vargas@universidad.edu", phone: "+51 911 444 444" },
            { name: "Lic. Patricia López", role: "Coordinadora", email: "patricia.lopez@universidad.edu", phone: "+51 922 555 555" },
            { name: "Lic. Sofia Castro", role: "Asistente", email: "sofia.castro@universidad.edu", phone: "+51 933 666 666" },
        ],
        program3: [
            { name: "Dr. Mario Jiménez", role: "Director", email: "mario.jimenez@universidad.edu", phone: "+51 944 777 777" },
            { name: "Lic. Ana Salinas", role: "Coordinadora", email: "ana.salinas@universidad.edu", phone: "+51 955 888 888" },
            { name: "Lic. Carlos Mendoza", role: "Asistente", email: "carlos.mendoza@universidad.edu", phone: "+51 966 999 999" },
        ],
        program4: [
            { name: "Dr. Samuel Torres", role: "Director", email: "samuel.torres@universidad.edu", phone: "+51 977 000 000" },
            { name: "Lic. Teresa Morales", role: "Coordinadora", email: "teresa.morales@universidad.edu", phone: "+51 988 111 111" },
            { name: "Lic. Fernando Ríos", role: "Asistente", email: "fernando.rios@universidad.edu", phone: "+51 999 222 222" },
        ],
        program5: [
            { name: "Dr. Miguel Álvarez", role: "Director", email: "miguel.alvarez@universidad.edu", phone: "+51 999 333 333" },
            { name: "Lic. Laura Villanueva", role: "Coordinadora", email: "laura.villanueva@universidad.edu", phone: "+51 988 444 444" },
            { name: "Lic. Pablo Fernández", role: "Asistente", email: "pablo.fernandez@universidad.edu", phone: "+51 977 555 555" },
        ],
        program6: [
            { name: "Dr. Ricardo Santos", role: "Director", email: "ricardo.santos@universidad.edu", phone: "+51 999 666 666" },
            { name: "Lic. Gabriela León", role: "Coordinadora", email: "gabriela.leon@universidad.edu", phone: "+51 999 777 777" },
            { name: "Lic. Mariana Córdova", role: "Asistente", email: "mariana.cordova@universidad.edu", phone: "+51 999 888 888" },
        ]
    };
